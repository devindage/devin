    ...
    $.extend({
        ...
        table: {
            ...
            init: function(options) {
                ...
                $.table.dateTransfer = $.common.isEmpty(options.dateTransfer) ? "" : options.dateTransfer
                _sortOrder = $.common.isEmpty(options.sortOrder) ? "asc" : options.sortOrder;
                _sortName = $.common.isEmpty(options.sortName) ? "" : options.sortName;
                _showFooter = $.common.isEmpty(options.showFooter) ? "" : options.showFooter;
            ...
            responseHandler: function(res) {
                if (res.code == 0) {
                    return { rows: res.rows, total: res.total,data: res.data };
                } else {
            ...
            search: function(formId) {
                ...
                params.queryParams = function(params) {
                    ...
                    $.each($("#" + currentId).serializeArray(), function(i, field) {
                        if(field.value && isDateTime(field.value)&&$.table.dateTransfer == '1') {
        ...
        operate: {
            ...
            // 修改信息 全屏,自定义标题
            editFullCustom: function(id,title) {
                var url = $.table._option.updateUrl.replace("{id}", id);
